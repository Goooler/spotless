 ...
 */
public class JacksonXml implements FormatterStepFactory {

	@Parameter
	private String version = JacksonXmlStep.defaultVersion();

	@Parameter
	private Map<String, Boolean> features = Collections.emptyMap();

	@Parameter
	private Map<String, Boolean> xmlFeatures = Collections.emptyMap();

	@Override
	public FormatterStep newFormatterStep(FormatterStepConfig stepConfig) {
		JacksonXmlConfig jacksonConfig = new JacksonXmlConfig();

		jacksonConfig.appendFeatureToToggle(features);
		jacksonConfig.appendXmlFeatureToToggle(xmlFeatures);

		return JacksonXmlStep
